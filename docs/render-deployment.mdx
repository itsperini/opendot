...
OpenDot still owns product data in `app_users`, organizations, memberships,
projects, devices, agents, deployments, sessions, and API keys. Supabase Auth
owns sign-in without making `auth.users` the product permissions table.
