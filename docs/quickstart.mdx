...
Open `https://local.drizzle.studio` to inspect the PostgreSQL schema and rows, including `app_users`, `local_auth_credentials`, organizations, versioned agents/pipelines, devices, deployments, sessions, events, and API keys.
