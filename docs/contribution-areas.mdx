...
| Media Transport                      | Evolve browser/device audio and data sessions across `/voice`, `/ws`, browser WebRTC, and future fleet paths.     | Current plus later work |
...
complete the realtime browser-session token and client-secret exchange. Device
realtime bridging, SFU-style media infrastructure, and fleet media paths are
future transport adapters, not rewrites of the control plane.
...
| Size   | Project brief                                                                             | Verification                                           |
| ------ | ----------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| Small  | Clarify one browser WebSocket, device WebSocket, or browser WebRTC flow in docs.           | Docs formatting and link checks                        |
