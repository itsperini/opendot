...
**Current state:** Agent Studio and Configuration provide the first draft-agent
workflow. Knowledge, tools, local AI/ML harnesses, and formal evals are future
surfaces rather than mature subsystems.
