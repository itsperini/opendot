...
<Frame caption="Browser Test connects to the runtime, streams microphone audio, and shows transcripts, responses, audio, timing, and logs.">
...
1. Select an agent in [Agent Studio](/agent-studio).
