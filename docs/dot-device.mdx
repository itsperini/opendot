...
<Frame caption="Dot Device manages runtime availability, device inventory, spoken-code pairing, and voice config binding.">
...
last seen time, and bound agent. Use **Check** to probe only the selected device
