...
OpenDot can run as one Docker Compose stack or as separate local npm processes:

| Process | Command | Default URL |
| --- | --- | --- |
| Compose stack | `docker compose --env-file .env.docker up --build` | `http://localhost:5173` |
| Platform API | `npm run api` | `http://localhost:8788/api` |
